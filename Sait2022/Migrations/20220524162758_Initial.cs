    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherTopic", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeacherTopic_Employees_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeacherTopic_QuestionsTopic_QuestionsTopicId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questions_QuestionsTopic_QuestionTopcId",
                        column: x => x.QuestionTopcId,
                        principalTable: "QuestionsTopic",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogsAnswers", x => new { x.QuestionsId, x.UsersId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LogsAnswers_Questions_QuestionsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentAnswers_TeacherTopic_TeacherTopicId",
                        column: x => x.TeacherTopicId,
                        principalTable: "TeacherTopic",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_QuestionTopcId",
                table: "Questions",
                column: "QuestionTopcId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAnswers_TeacherTopicId",
                table: "StudentAnswers",
                column: "TeacherTopicId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherTopic_QuestionsTopicId",
                table: "TeacherTopic",
                column: "QuestionsTopicId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherTopic_StudentId",
                table: "TeacherTopic",
                column: "StudentId");
        }
